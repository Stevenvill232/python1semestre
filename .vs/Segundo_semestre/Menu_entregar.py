...
#### Control de puntos del parcial 1 (de la mañana)

def punto_1_parcial_am():
    vector=leer_lista()
    matriz=leer_matriz()
...
def menu_ejercicios_parcial_1_am():
    while True:
        os.system('cls')
        print('______MENU EJERCICIOS DEL PARCIAL 1 (AM)_____ ')
        print('---------------------------------')
        print('   1. Ejercicio 1')
        print('   2. Ejercicio 2')
        print('   3. Ejercicio 3')
...
def menuPrincipal():
    while True:
        ...
        print('   3. Parcial 1 (AM)')
        print('   4. Parcial 2 (PM)')
        print('   ')
        print('   (0). Salir')
        print('')
        print('--------------------------------')
