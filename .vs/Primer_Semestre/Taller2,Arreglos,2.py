...
def Taller2_Punto4():
    print("Ejercicio 4 (Se tienen dos vectores, el primero determina el rango de datos que tendra el segundo vector)")
    datos = []
    rango = []
...
#Ejercicio 10 (Encontrar el segundo y tercer fibonacci,sus posiciones, reemplazzar las posiciones comprendidad entre estos dos por el factorial del fibonacci menor de los 2)
def Taller2_Punto10():
